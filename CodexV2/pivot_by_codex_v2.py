...
# --- Show All Data Rows and Download ---
if st.session_state.df is not None:
    ...
    # Uncomment and adjust the following lines to store the CSV in HDFS
            ...
            for i, f_config in enumerate(active_filters):
                ...
                if is_date_op_code_gen:
                    ...
                    if op == "is between (inclusive)":
                        ...
                        val_date_str = pd.to_datetime(val_config).strftime('%Y-%m-%d')
                        code_lines.append(f"val_dt_{i} = pd.to_datetime('{val_date_str}')")
...
# --- Initial Message ---
    ...
    st.info(
        ...
        "This app allows you to create multiple pivot tables from your data, with flexible options for rows, columns, values, and filters."
        " You can also tie the Extra2 filter across pivots for consistent filtering.\n\n"
