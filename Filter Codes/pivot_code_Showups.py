...
# 2. Apply Filters
df_filtered = df_filtered[df_filtered['ScheduledFor'].astype(str).str.contains(r'''-05-''', case=False, na=False)]
df_filtered = df_filtered[df_filtered['ShowedUp'] == 'Yes']
...
start_date_2 = pd.to_datetime('2025-04-01')
end_date_2 = pd.to_datetime('2025-05-31')
df_filtered = df_filtered[df_filtered['CreateDt'].between(start_date_2, end_date_2, inclusive='both')]
